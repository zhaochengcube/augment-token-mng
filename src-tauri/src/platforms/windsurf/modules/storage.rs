...
use crate::windsurf::models::{Account, AccountIndex, AccountSummary};
use std::sync::Arc;
...
/// 创建 Windsurf 本地存储实例
pub fn create_windsurf_storage(
    app_handle: &tauri::AppHandle,
) -> Result<Arc<WindsurfLocalStorage>, String> {
    WindsurfLocalStorage::new(app_handle)
        .map(Arc::new)
        .map_err(|e| format!("Failed to create Windsurf storage: {}", e))
}
