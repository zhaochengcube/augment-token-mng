        ...
        <div class="flex flex-col gap-[18px]">
          ...
          <div class="flex items-center gap-[18px]">
            ...
            <div class="flex flex-1 flex-wrap items-center gap-2.5">
              <a href="https://github.com/zhaochengcube/augment-token-mng" target="_blank" class="btn btn--sm btn-tech-accent">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" />
                </svg>
                <span>{{ $t('app.appHome') }}</span>
              </a>
              <a href="https://github.com/zhaochengcube/augment-code-auto" target="_blank" class="btn btn--sm btn-tech-accent">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
