  ...
  >
    ...
    <div v-else class="flex flex-col gap-2.5">
      ...
      >
        ...
        >
          ...
          <div v-else class="h-3.5 w-3.5 border-2 border-current/30 border-t-current rounded-full animate-spin"></div>
        </button>
      </div>
    </div>
    ...
    <template #footer>
      ...
      <button v-else class="btn btn--primary" disabled>
        <div class="h-3.5 w-3.5 border-2 border-current/30 border-t-current rounded-full animate-spin"></div>
