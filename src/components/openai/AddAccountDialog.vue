  ...
  >
    ...
    <div v-if="addMethod === 'oauth'" class="animate-fade-in">
      ...
      >
        ...
        <span v-if="isLoading">{{ $t('platform.openai.addAccountDialog.adding') }}</span>
        <span v-else>{{ $t('platform.openai.addAccountDialog.openaiLogin') }}</span>
      </button>
    ...
    <template #footer>
      ...
      >
        ...
        <span v-else>{{ $t('platform.openai.addAccountDialog.add') }}</span>
      </button>
    </template>
  </BaseModal>
</template>
