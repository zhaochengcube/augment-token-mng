export default {
  ...
  antigravityConfig: {
    title: 'Antigravity Path Configuration',
    useCustomPath: 'Use custom executable path',
    useCustomPathHelp: 'Enable to specify Antigravity installation location, useful for non-standard installations',
    customPath: 'Custom Path',
    pathPlaceholder: 'Select Antigravity executable...',
    pathHelp: 'macOS: Select Antigravity.app or its executable; Windows: Select Antigravity.exe; Linux: Select antigravity executable',
    browse: 'Browse',
    ...
    reset: 'Reset to Default',
    deleting: 'Deleting...',
    selectExecutable: 'Select Antigravity Executable',
    customized: 'Custom Path',
    default: 'Default Path',
    messages: {
      loadFailed: 'Failed to load configuration: {error}',
      selectFailed: 'Failed to select file: {error}',
      pathRequired: 'Please set a custom path first',
      pathValid: 'Path validation successful!',
      pathInvalid: 'Path validation failed: {error}',
      saveSuccess: 'Configuration saved successfully!',
      saveFailed: 'Failed to save configuration: {error}',
      launchSuccess: 'Antigravity launched successfully!',
      launchFailed: 'Launch failed: {error}',
      deleteSuccess: 'Configuration deleted, restored to default settings',
      deleteFailed: 'Failed to delete configuration: {error}',
      confirmDelete: 'Are you sure you want to delete the configuration? This will restore the default path search behavior.'
    }
  },
  credit: {
