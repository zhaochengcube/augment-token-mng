export default {
  ...
  messages: {
    ...
    refreshTokenCopied: 'Refresh Token 已复制到剪贴板!',
  ...
  antigravityConfig: {
    title: 'Antigravity 路径配置',
    useCustomPath: '使用自定义可执行文件路径',
    useCustomPathHelp: '启用后可以指定 Antigravity 的安装位置，适用于非标准安装路径',
    customPath: '自定义路径',
    pathPlaceholder: '选择 Antigravity 可执行文件...',
    pathHelp: 'macOS: 选择 Antigravity.app 或其中的可执行文件；Windows: 选择 Antigravity.exe；Linux: 选择 antigravity 可执行文件',
    browse: '浏览',
    currentPath: '当前使用路径',
    defaultPaths: '默认搜索路径',
    save: '保存配置',
    ...
    reset: '重置为默认',
    deleting: '删除中...',
    selectExecutable: '选择 Antigravity 可执行文件',
    customized: '自定义路径',
    default: '默认路径',
    messages: {
      loadFailed: '加载配置失败: {error}',
      selectFailed: '选择文件失败: {error}',
      pathRequired: '请先设置自定义路径',
      pathValid: '路径验证成功！',
      pathInvalid: '路径验证失败: {error}',
      saveSuccess: '配置保存成功！',
      saveFailed: '保存配置失败: {error}',
      launchSuccess: 'Antigravity 启动成功！',
      launchFailed: '启动失败: {error}',
      deleteSuccess: '配置已删除，已恢复为默认设置',
      deleteFailed: '删除配置失败: {error}',
      confirmDelete: '确定要删除配置吗？这将恢复为默认的路径查找方式。'
    }
  },
  credit: {
    title: 'Credit 使用统计',
  ...
  platform: {
    ...
    antigravity: {
      ...
      refreshing: '刷新中...',
      delete: '删除',
      copyRefreshToken: '复制 Refresh Token',
      lastUsed: '最后使用',
      createdAt: '创建时间',
